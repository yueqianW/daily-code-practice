    ...
    Pager.prototype = {
        ...
        renderHtml: function() {
            ...
            if (options.pageIndex > 0) {
                html.push('<a page="' + (options.pageIndex - 5) + '" href="' + this.buildPageUrl(options.pageIndex + 1) + '" class="flip">' + options.prevText + '</a>');
            } else {
            ...
            if (options.pageIndex < options.pageCount - 1) {
                html.push('<a page="' + (options.pageIndex + 5) + '" href="' + this.buildPageUrl(options.pageIndex + 1) + '" class="flip">' + options.nextText + '</a>');
            } else {
